...
def main():
    ...
    # ensure log directory exists and persist run parameters for later summary
    try:
        os.makedirs(args.log_dir, exist_ok=True)
    except Exception:
        pass
    params_path = os.path.join(args.log_dir, "params.json")
    try:
        ...
        # best-effort; continue even if params cannot be saved
        pass
